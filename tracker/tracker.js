/*!
 * Lightweight Heatmap Tracker v1.1
...
(function () {
  ...
  var SECTION_VISIBLE_THRESHOLD = 0.5;
  var MIN_SECTION_TIME_MS = 500;
  ...
  // CHANGED in v1.1: include hostname so multiple landing domains stay separate
  function pageUrl() {
