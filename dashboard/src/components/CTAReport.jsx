...
export default function CTAReport({ rows }) {
  ...
  return (
    <div className="card">
      ...
      {!rows?.length ? (
        <div className="empty">Add <code>data-track="..."</code> to your CTAs</div>
      ) : (
        <table className="tbl">
          <thead>
            <tr>
              <th>CTA</th>
              <th style={{ width: 200 }}>Clicks</th>
              <th style={{ width: 70, textAlign: "right" }}>Total</th>
              <th style={{ width: 70, textAlign: "right" }}>Mobile</th>
              <th style={{ width: 70, textAlign: "right" }}>Desktop</th>
